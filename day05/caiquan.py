...
def caiquan():
    ...
    while select not in ['1','2','3']:
        ...
        if humchoice == comchoice:
            print('电脑:\033[041;1m%s\033[0m vs 玩家:\033[041;1m%s\033[0m result:\033[031;1m平局\033[0m' % (comchoice,humchoice))
            return 'draw'
        if [humchoice,comchoice] in wins:
            print('电脑:\033[041;1m%s\033[0m vs 玩家:\033[041;1m%s\033[0m result:\033[031;1m你赢了\033[0m' % (comchoice, humchoice))
            return 'win'
        else:
